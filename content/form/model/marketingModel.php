<?php
function insertMkt( $fecha, $semana, $programa, $objetivo, $herramienta, $colaboracion, $topico, $post, $contenido, 
$facebook, $instagram,$tiktok,$linkedin,$otros,$linkBlog,$linkRRSS,$linkWeb,$linkForm,$linkYoutube,$arte,$logo,$comentarios,$responsable,$mexico,$chile,$ecuador,$latam,$redsocial,$status)
{
    ...
    $sqlInsertx = "INSERT INTO `dbcontenidoredes`(`fecha`, `semana`,  `pais`, `objetivo`, `herramienta`, `colaboracion`, `post`, `contenido`, `redsocial`, `topico`, `facebook`, `instagram`, `tiktok`, `linkedin`, `otros`, `linkblog`, `linkrrss`, `linkweb`, `linkform`, `linkyoutube`, `arte`, `logos`, `comentario`, `alcance`, `megusta`, `compartir`, `punt_alcance`, `punt_megusta`, `punt_compartir`, `puntuacion`, `status`, `responsable`)
                    VALUES ('$fecha','$semana','','$objetivo','$herramienta','$colaboracion','$post','$contenido','$redsocial','$topico','$facebook','$instagram','$tiktok','$linkedin','$otros','$linkBlog','$linkRRSS','$linkWeb','$linkForm','$linkYoutube','$arte','$logo','$comentarios','','','','','','','','$status','$responsable')";
    $result = mysqli_query($conection, $sqlInsertx);
        ...
        if($mexico == 1){
            ...
            $sqlInsert = "INSERT INTO dbcontenidoredes". $programa . "(`fecha`, `semana`,  `pais`, `objetivo`, `herramienta`, `colaboracion`, `post`, `contenido`, `redsocial`, `topico`, `facebook`, `instagram`, `tiktok`, `linkedin`, `otros`, `linkblog`, `linkrrss`, `linkweb`, `linkform`, `linkyoutube`, `arte`, `logos`, `comentario`, `alcance`, `megusta`, `compartir`, `punt_alcance`, `punt_megusta`, `punt_compartir`, `puntuacion`, `status`, `responsable`)
        ...
        $sqlInsert2 = "INSERT INTO dbcontenidoredes". $programa . "(`fecha`, `semana`,  `pais`, `objetivo`, `herramienta`, `colaboracion`, `post`, `contenido`, `redsocial`, `topico`, `facebook`, `instagram`, `tiktok`, `linkedin`, `otros`, `linkblog`, `linkrrss`, `linkweb`, `linkform`, `linkyoutube`, `arte`, `logos`, `comentario`, `alcance`, `megusta`, `compartir`, `punt_alcance`, `punt_megusta`, `punt_compartir`, `puntuacion`, `status`, `responsable`)
        SELECT `fecha`, `semana`,  `pais`, `objetivo`, `herramienta`, `colaboracion`, `post`, `contenido`, `redsocial`, `topico`, `facebook`, `instagram`, `tiktok`, `linkedin`, `otros`, `linkblog`, `linkrrss`, `linkweb`, `linkform`, `linkyoutube`, `arte`, `logos`, `comentario`, `alcance`, `megusta`, `compartir`, `punt_alcance`, `punt_megusta`, `punt_compartir`, `puntuacion`, `status`, `responsable` FROM dbcontenidoredes WHERE `fecha`>'$date'";
        ...
        $sqlInsert3 = "INSERT INTO dbcontenidoredes". $programa . "(`fecha`, `semana`,  `pais`, `objetivo`, `herramienta`, `colaboracion`, `post`, `contenido`, `redsocial`, `topico`, `facebook`, `instagram`, `tiktok`, `linkedin`, `otros`, `linkblog`, `linkrrss`, `linkweb`, `linkform`, `linkyoutube`, `arte`, `logos`, `comentario`, `alcance`, `megusta`, `compartir`, `punt_alcance`, `punt_megusta`, `punt_compartir`, `puntuacion`, `status`, `responsable`)
        SELECT `fecha`, `semana`,  `pais`, `objetivo`, `herramienta`, `colaboracion`, `post`, `contenido`, `redsocial`, `topico`, `facebook`, `instagram`, `tiktok`, `linkedin`, `otros`, `linkblog`, `linkrrss`, `linkweb`, `linkform`, `linkyoutube`, `arte`, `logos`, `comentario`, `alcance`, `megusta`, `compartir`, `punt_alcance`, `punt_megusta`, `punt_compartir`, `puntuacion`, `status`, `responsable` FROM dbcontenidoredes WHERE `fecha`>'$date'";
